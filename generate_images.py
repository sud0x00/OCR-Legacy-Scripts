# script which generates images when the required text and font is given as the input
...
font = ImageFont.truetype('font.ttf', 120 , layout_engine=ImageFont.LAYOUT_RAQM)
